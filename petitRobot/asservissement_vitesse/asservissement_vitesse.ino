...
void asservissement()
{
    ...
    vitMoteur_G = kp*erreur_G + ki*somme_erreur_G + kd*delta_erreur_G;  //somme des trois erreur_Gs
    vitMoteur_D = kp*erreur_D + ki*somme_erreur_D + kd*delta_erreur_D;  //somme des trois erreur_Gs
